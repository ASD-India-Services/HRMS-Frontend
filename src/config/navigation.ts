...
export const navigationConfig: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Grievance Types', href: '/grievance-types', icon: ICONS.grievances, requiredPermission: 'grievances.edit' },
      ...
      { label: 'Overtime Types', href: '/overtime-types', icon: ICONS.overtime, requiredPermission: 'overtime.edit' },
      ...
      { label: 'Exit Interviews', href: '/exit-interviews', icon: ICONS.settlements, requiredPermission: 'exit_interviews.view', featureFlag: null },
      { label: 'Holiday Assignments', href: '/holiday-assignments', icon: ICONS.leaves, requiredPermission: 'holidays.manage', featureFlag: null },
      { label: 'Holiday Lists', href: '/holiday-lists', icon: ICONS.leaves, requiredPermission: 'holidays.manage' },
      { label: 'Health Insurance', href: '/health-insurance', icon: ICONS.employees, requiredPermission: 'health_insurance.view' },
      { label: 'Cost Centers', href: '/cost-centers', icon: ICONS.departments, requiredPermission: 'cost_centers.view' },
      { label: 'Document Types', href: '/document-types', icon: ICONS.designations, requiredPermission: 'documents.manage' },
      { label: 'Employee Documents', href: '/employee-documents', icon: ICONS.designations, requiredPermission: 'documents.view' },
      { label: 'Appointment Letters', href: '/appointment-letters', icon: ICONS.designations, requiredPermission: 'appointment_letters.view' },
    ],
  },
  {
    label: 'Admin',
