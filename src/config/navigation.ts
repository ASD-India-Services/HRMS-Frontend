...
export const navigationConfig: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Departments', href: '/departments', icon: ICONS.departments, requiredPermission: 'employees.view', featureFlag: 'employees_enabled' },
      { label: 'Designations', href: '/designations', icon: ICONS.designations, requiredPermission: 'employees.view', featureFlag: 'employees_enabled' },
      { label: 'Grades', href: '/employee-grades', icon: ICONS.designations, requiredPermission: 'employees.view', featureFlag: 'employees_enabled' },
      { label: 'Approvers', href: '/department-approvers', icon: ICONS.leaveApprovals, requiredPermission: 'employees.view', featureFlag: 'employees_enabled' },
      { label: 'Branches', href: '/branches', icon: ICONS.departments, requiredPermission: 'employees.view', featureFlag: 'employees_enabled' },
      { label: 'Transfers', href: '/transfers', icon: ICONS.departments, requiredPermission: 'employees.view', featureFlag: 'employees_enabled' },
      { label: 'Promotions', href: '/promotions', icon: ICONS.designations, requiredPermission: 'employees.view', featureFlag: 'employees_enabled' },
    ],
  },
  {
    label: 'Leaves',
    items: [
      { label: 'My Leaves', href: '/leaves', icon: ICONS.leaves, requiredPermission: 'leaves.view', featureFlag: 'leaves_enabled' },
      ...
      { label: 'Leave Policies', href: '/leave-policies', icon: ICONS.leaves, requiredPermission: 'leaves.view', featureFlag: 'leaves_enabled' },
      { label: 'Policy Assignments', href: '/leave-policy-assignments', icon: ICONS.leaves, requiredPermission: 'leaves.view', featureFlag: 'leaves_enabled' },
      { label: 'Block Lists', href: '/leave-block-lists', icon: ICONS.leaves, requiredPermission: 'leaves.view', featureFlag: 'leaves_enabled' },
      { label: 'Adjustments', href: '/leave-adjustments', icon: ICONS.leaves, requiredPermission: 'leaves.view', featureFlag: 'leaves_enabled' },
      { label: 'Earned Leave Schedules', href: '/earned-leave-schedules', icon: ICONS.leaves, requiredPermission: 'leaves.view', featureFlag: 'leaves_enabled' },
    ],
  },
  {
    label: 'Attendance',
    items: [
      ...
      { label: 'Attendance Upload', href: '/attendance-upload', icon: ICONS.attendance, requiredPermission: 'attendance.view', featureFlag: 'attendance_enabled' },
      { label: 'Geo Locations', href: '/geofence-locations', icon: ICONS.attendance, requiredPermission: 'attendance.view', featureFlag: 'attendance_enabled' },
      ...
      { label: 'Shift Schedules', href: '/shift-schedules', icon: ICONS.shifts, requiredPermission: 'attendance.view', featureFlag: 'shifts_enabled' },
    ],
  },
  {
    label: 'Payroll',
    items: [
      { label: 'Payroll Runs', href: '/payroll/runs', icon: ICONS.payroll, requiredPermission: 'payroll.view', featureFlag: 'payroll_enabled' },
      { label: 'Salary Slips', href: '/payroll', icon: ICONS.salarySlips, requiredPermission: 'payroll.view', featureFlag: 'payroll_enabled' },
      { label: 'Components', href: '/salary-components', icon: ICONS.salarySlips, requiredPermission: 'payroll.view', featureFlag: 'payroll_enabled' },
      { label: 'Assignments', href: '/salary-structure-assignments', icon: ICONS.payroll, requiredPermission: 'payroll.view', featureFlag: 'payroll_enabled' },
      { label: 'Payroll Periods', href: '/payroll-periods', icon: ICONS.payroll, requiredPermission: 'payroll.view', featureFlag: 'payroll_enabled' },
      { label: 'Corrections', href: '/payroll-corrections', icon: ICONS.payroll, requiredPermission: 'payroll.view', featureFlag: 'payroll_enabled' },
      { label: 'Incentives', href: '/employee-incentives', icon: ICONS.payroll, requiredPermission: 'payroll.view', featureFlag: 'payroll_enabled' },
      { label: 'Gratuity', href: '/gratuity', icon: ICONS.payroll, requiredPermission: 'payroll.view', featureFlag: 'payroll_enabled' },
    ],
  },
  {
    label: 'Recruitment',
    items: [
      ...
      { label: 'Interview Types', href: '/interview-types', icon: ICONS.recruitment, requiredPermission: 'recruitment.view', featureFlag: 'recruitment_enabled' },
      { label: 'Job Templates', href: '/job-templates', icon: ICONS.recruitment, requiredPermission: 'recruitment.view', featureFlag: 'recruitment_enabled' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'KRAs', href: '/kras', icon: ICONS.appraisals, requiredPermission: 'appraisals.view', featureFlag: 'appraisals_enabled' },
      { label: 'Templates', href: '/appraisal-templates', icon: ICONS.appraisals, requiredPermission: 'appraisals.view', featureFlag: 'appraisals_enabled' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Expense Taxes', href: '/expense-taxes', icon: ICONS.expenses, requiredPermission: 'expenses.view', featureFlag: 'expenses_enabled' },
    ],
  },
  {
    label: 'Learning',
    items: [
      ...
      { label: 'Training Programs', href: '/training-programs', icon: ICONS.training, requiredPermission: 'training.view', featureFlag: 'training_enabled' },
      { label: 'Training Results', href: '/training-results', icon: ICONS.training, requiredPermission: 'training.view', featureFlag: 'training_enabled' },
    ],
  },
  {
    label: 'More',
    items: [
      ...
      { label: 'Exit Interviews', href: '/exit-interviews', icon: ICONS.settlements, requiredPermission: 'employees.view', featureFlag: null },
      { label: 'Holiday Assignments', href: '/holiday-assignments', icon: ICONS.leaves, requiredPermission: 'employees.view', featureFlag: 'holidays_enabled' },
      { label: 'Health Insurance', href: '/health-insurance', icon: ICONS.employees, requiredPermission: 'employees.view', featureFlag: 'employees_enabled' },
      { label: 'Cost Centers', href: '/cost-centers', icon: ICONS.departments, requiredPermission: 'employees.view', featureFlag: 'employees_enabled' },
      { label: 'Document Types', href: '/document-types', icon: ICONS.designations, requiredPermission: 'employees.view', featureFlag: 'employees_enabled' },
      ...
      { label: 'Appointment Letters', href: '/appointment-letters', icon: ICONS.designations, requiredPermission: 'employees.view', featureFlag: 'employees_enabled' },
    ],
  },
  {
    label: 'Admin',
