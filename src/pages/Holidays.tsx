...
const columns: ColumnDef<Record<string, unknown>>[] = [
  ...
  { key: 'entries_count', header: 'Holidays', sortable: true },
];
...
const createFields: FieldConfig[] = [
  { key: 'name', label: 'Holiday List Name', type: 'text', required: true, placeholder: 'e.g., India 2024' },
...
export default function Holidays() {
  ...
  const handleEdit = async (data: Record<string, unknown>) => {
    ...
    setEditLoading(true);
    try {
      await api.patch(`/api/v1/holidays/holiday-lists/${editRecord.id}/`, data);
      setEditRecord(null);
      queryResult.refetch();
    } finally {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <div className="mb-6 flex items-center justify-between">
        <div><h1 className="text-2xl font-bold text-gray-900">Holiday Lists</h1><p className="mt-1 text-sm text-gray-600">Manage holiday lists for your organization and locations</p></div>
