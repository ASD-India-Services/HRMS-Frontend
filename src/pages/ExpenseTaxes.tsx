...
const createFields: FieldConfig[] = [
  { key: 'name', label: 'Name', type: 'text', required: true, placeholder: 'Tax name' },
  { key: 'rate', label: 'Rate (%)', type: 'number', required: true, placeholder: 'Tax rate percentage' },
  { key: 'description', label: 'Description', type: 'textarea', placeholder: 'Tax description' },
];
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <div className="mb-6 flex items-center justify-between">
        ...
        <CreateButton label="Create Tax" onClick={() => setShowCreate(true)} />
      </div>
